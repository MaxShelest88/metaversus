  ...
  <section className={`${styles.paddings} relative z-10`}>
    ...
    >
      ...
      >
        ...
        <div>
          <h4 className="font-bold sm:text-[32px] text-[26] sm:leading-[40px] leading-[46px] text-white">
            Samantha
          </h4>
      ...
      <motion.div
        ...
        className="relative flex-1 flex justify-center flex-col items-center "
      >
        <img
          src="/planet-09.png"
          alt="planet-09"
